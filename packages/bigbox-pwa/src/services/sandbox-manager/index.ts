import {
    addSandbox as dbAddSandbox,
    getSandbox as dbGetSandbox,
    listSandboxes as dbListSandboxes,
    deleteSandbox as dbDeleteSandbox,
    calculateHash as dbCalculateHash,
...
export interface Sandbox {
    id: string; // This will be the content hash
    html: string;
...
// Track active iframe sandboxes
interface ActiveSandbox {
    id: string;
    iframe: HTMLIFrameElement;
    container: HTMLElement;
    status: 'loading' | 'loaded' | 'paused' | 'error';
    meta?: Record<string, any>;
}
 ...
 */
export async function create(html: string, meta?: Record<string, any>): Promise<string> {
 ...
 */
export async function list(): Promise<Sandbox[]> {
 ...
 */
export async function get(id: string): Promise<Sandbox | undefined> {
 ...
 */
export async function run(id: string, containerElement: HTMLElement): Promise<void> {
 ...
 */
export function getActiveSandboxes(): Array<{id: string, status: string, meta?: Record<string, any>}> {
 ...
 */
export async function getHash(htmlContent: string): Promise<string> {
